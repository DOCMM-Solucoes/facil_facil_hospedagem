...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference("Establishment.count") do
      post establishments_url, params: { establishment: { address: @establishment.address, cep: @establishment.cep, city: @establishment.city, cpf: @establishment.cpf, name: @establishment.name, owner: @establishment.owner, phone: @establishment.phone, qty_bedrooms: @establishment.qty_bedrooms, site: @establishment.site, state: @establishment.state } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { address: @establishment.address, cep: @establishment.cep, city: @establishment.city, cpf: @establishment.cpf, name: @establishment.name, owner: @establishment.owner, phone: @establishment.phone, qty_bedrooms: @establishment.qty_bedrooms, site: @establishment.site, state: @establishment.state } }
