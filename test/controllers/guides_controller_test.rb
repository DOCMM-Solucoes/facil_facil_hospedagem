...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference("Guide.count") do
      post guides_url, params: { guide: { address: @guide.address, cep: @guide.cep, city: @guide.city, cpf: @guide.cpf, enterprise: @guide.enterprise, guide: @guide.guide, phone: @guide.phone, uf: @guide.uf } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { address: @guide.address, cep: @guide.cep, city: @guide.city, cpf: @guide.cpf, enterprise: @guide.enterprise, guide: @guide.guide, phone: @guide.phone, uf: @guide.uf } }
