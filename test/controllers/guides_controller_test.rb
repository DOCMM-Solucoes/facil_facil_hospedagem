...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference("Guide.count") do
      post guides_url, params: { guide: { city: @guide.city, cnpj: @guide.cnpj, cpf: @guide.cpf, enterprise: @guide.enterprise, guide: @guide.guide, phone: @guide.phone, uf: @guide.uf } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { city: @guide.city, cnpj: @guide.cnpj, cpf: @guide.cpf, enterprise: @guide.enterprise, guide: @guide.guide, phone: @guide.phone, uf: @guide.uf } }
