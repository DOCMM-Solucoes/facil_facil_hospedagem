...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference("Guide.count") do
      post guides_url, params: { guide: { cnpj: @guide.cnpj, company: @guide.company, cpf: @guide.cpf, name: @guide.name, phone: @guide.phone } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { cnpj: @guide.cnpj, company: @guide.company, cpf: @guide.cpf, name: @guide.name, phone: @guide.phone } }
